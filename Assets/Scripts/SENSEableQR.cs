...
namespace Microsoft.MixedReality.SENSEableQR
{
    ...
    public class SENSEableQR : MonoBehaviour, IMixedRealityPointerHandler
    {
        ...
        void Start()
        {
            alignmentManager = GameObject.Find("AlignmentManager").GetComponent<AlignmentManager>();
        ...
        void UpdatePropertiesDisplay()
        {
            ...
            if (qrCode != null && lastTimeStamp != qrCode.SystemRelativeLastDetectedTime.Ticks)
            {
                ...
                // Update AlignmentManager
                print("UPDATED ALIGNMENT");
                alignmentManager.AddScan(transform.position, transform.eulerAngles, PhysicalSize);
            }
        }
